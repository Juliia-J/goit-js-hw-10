...
function onSearch(e) {
    ...
    (0, _fetchCountriesDefault.default)(searchName).then((0, _countryCardDefault.default)).catch((error)=>console.log(error)).finally(()=>form.reset());
}

},{"./css/styles.css":"1CY4s","notiflix":"5WWYd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fetchCountries":"fTQqv","./countryCard":"3csrW"}],"1CY4s":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3csrW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "countryCard", ()=>countryCard);
function countryCard(country1) {
    refs.countryContainer.innerHTML = data.results.map((country)=>`<div><h2>${country.flags}${country.name}</h2><p>Capital:${country.capital}</p><p>Population:${country.population}</p><p>Languages:${country.languages}</p>`).join("");
}
